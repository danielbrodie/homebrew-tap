class OscRecord < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      url "https://github.com/danielbrodie/osc-record-bin/releases/download/v2.4.62/osc-record_darwin_arm64.tar.gz"
      sha256 "d5a0ca2a54987a181a9dc91d451d05dee9dc083955eecdd407e0785b500df823"

      resource "osc-recorder" do
        url "https://github.com/danielbrodie/osc-record-bin/releases/download/v2.4.62/osc-recorder_darwin_arm64.tar.gz"
        sha256 "41b44908a4aa501a3540beeb8f645d84bf97a61a5ef44229a913430a47a81c35"
      end
    end
  end
