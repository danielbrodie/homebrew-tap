class OscRecord < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      url "https://github.com/danielbrodie/osc-record-bin/releases/download/v2.4.29/osc-record_darwin_arm64.tar.gz"
      sha256 "c7d15e7e44ed48944cb35b78e58e371e685d65c03a669da6f4e7290f8b74dd08"

      resource "osc-recorder" do
        url "https://github.com/danielbrodie/osc-record-bin/releases/download/v2.4.29/osc-recorder_darwin_arm64.tar.gz"
        sha256 "c07f5ced58c33673e2abfbdcfbf7b9ffae64db82a214ebdf0dcdd6843bdcbc44"
      end
    end
  end
